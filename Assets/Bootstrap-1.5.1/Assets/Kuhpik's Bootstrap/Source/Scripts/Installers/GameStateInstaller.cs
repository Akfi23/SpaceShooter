...
namespace Kuhpik
{
    public class GameStateInstaller : Installer
    {
        ...
        [EnumPaging]
        [SerializeField] [NaughtyAttributes.HideIf("useArray")] GameStateID firstGameState;
        [EnumPaging]
        [SerializeField] [NaughtyAttributes.ShowIf("useArray")] GameStateID[] gameStatesOrder;
